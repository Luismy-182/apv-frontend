...
//si no importas useState y lo estas usando, la aplicacion truena y se queda la pantalla en blanco
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row">
        ...
        <div className={`${mostrarFormulario ? 'block' : 'hidden'} md:block md:w-1/2 lg:2/5`}><Formulario /></div>
